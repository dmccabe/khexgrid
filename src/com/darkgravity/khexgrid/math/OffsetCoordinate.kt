...
data class OffsetCoordinate(val x: Int = 0, val y: Int = 0, val offsetType: OffsetCoordinateType = OffsetCoordinateType(PointyTop, true)) {
    ...
    operator fun plus(point: GridPoint2) = OffsetCoordinate(x + point.x, y + point.y, offsetType)

    operator fun minus(coordinate: OffsetCoordinate) = OffsetCoordinate(x - coordinate.x, y - coordinate.y, offsetType)

    operator fun minus(point: GridPoint2) = OffsetCoordinate(x - point.x, y - point.y, offsetType)
